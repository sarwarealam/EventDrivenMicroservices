...
@Component
public class CreateOrderCommandInterceptorr implements MessageDispatchInterceptor<CommandMessage<?>> {

	
	private static final Logger log = LoggerFactory.getLogger(CreateOrderCommandInterceptorr.class);
